...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "VIVIFY Automation | AI Automation Engineer" },
      ...
      { property: "og:title", content: "VIVIFY Automation | AI Automation Engineer" },
      ...
      { name: "twitter:title", content: "VIVIFY Automation | AI Automation Engineer" },
