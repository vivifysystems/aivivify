...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "VIVIFY Automation | AI Automation Specialist" },
      ...
      { property: "og:title", content: "VIVIFY Automation | AI Automation Specialist" },
      ...
      { name: "twitter:title", content: "VIVIFY Automation | AI Automation Specialist" },
